...
public class ARC {
    ...
    public static void handleCacheMissB1B2() {
    ...
    public static void handleCacheMissB1() {
        if (B1.size() >= B2.size()) {
            i_del1 = 1;
        } else {
    ...
    public static void handleCacheMissB2() {
        if (B2.size() >= B1.size()) {
            i_del2 = 1;
        } else {
    ...
    public static void printResults(String str_fileName) {
